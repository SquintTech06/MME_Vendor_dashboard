...
import { Eye, EyeOff, CheckCircle, AlertCircle, ArrowRight, ArrowLeft, Phone, Mail, User, Building2 } from 'lucide-react';
...
const VendorRegistration = () => {
  ...
  const vendorTypes = [
    { value: 'venue', label: 'Venue', icon: Building2, desc: 'Wedding halls, banquet halls, outdoor venues' },
    { value: 'caterer', label: 'Caterer', icon: User, desc: 'Food and catering services' },
    { value: 'decorator', label: 'Decorator', icon: User, desc: 'Event decoration and styling' },
    { value: 'photographer', label: 'Photographer', icon: User, desc: 'Photography and videography' }
  ];
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const response = {
        success: true,
        status: 201,
        message: "Vendor registered. Verify phone to activate.",
        data: { vendorId: "68b5c681b709f05528ef0203" }
      };
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      ...
      <div className="mb-6">
              ...
              >
                <div className="flex items-start space-x-3">
                  <Icon className={`w-6 h-6 mt-0.5 ${
                    formData.vendorType === type.value ? 'text-blue-600' : 'text-gray-400'
                  }`} />
                  <div className="flex-1">
                    <h3 className={`font-['Manrope'] font-semibold ${
                      formData.vendorType === type.value ? 'text-blue-900' : 'text-gray-900'
                    }`}>
                      {type.label}
                    </h3>
                    <p className={`font-['Inter'] text-sm mt-1 ${
                      formData.vendorType === type.value ? 'text-blue-700' : 'text-gray-600'
                    }`}>
                      {type.desc}
                    </p>
                  </div>
        ...
        {errors.vendorType && <p className="text-red-500 text-sm mt-1 font-['Inter']">{errors.vendorType}</p>}
      </div>
      ...
      <div>
        ...
        {errors.password && <p className="text-red-500 text-sm mt-1 font-['Inter']">{errors.password}</p>}
    ...
    <div className="text-center space-y-6">
      ...
      <div className="max-w-sm mx-auto">
        <input
          ...
          maxLength="6"
        />
        {errors.otp && <p className="text-red-500 text-sm mt-2 font-['Inter']">{errors.otp}</p>}
      </div>
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-['Manrope'] font-semibold py-3 px-6 rounded-lg transition-colors duration-200"
        >
          {loading ? (
    ...
    <div className="text-center space-y-6">
      ...
      <div>
        ...
        <p className="font-['Inter'] text-gray-600 max-w-md mx-auto">
          Your account has been created and verified successfully. You can now complete your profile and start receiving bookings.
        </p>
      </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="text-left">
            ...
            <p className="font-['Inter'] text-sm text-yellow-700">
              Your account is currently pending approval. Our team will review your information and activate your account within 24-48 hours.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-['Manrope'] font-semibold py-3 px-6 rounded-lg transition-colors duration-200"
        >
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-2">
              <span className="font-['Inter'] text-sm text-gray-600">Step {step} of 3</span>
              <span className="font-['Inter'] text-sm text-gray-600">{Math.round((step / 3) * 100)}%</span>
            </div>
